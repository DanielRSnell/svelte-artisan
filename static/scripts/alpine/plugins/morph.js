(() => {
	...
	function h(t, l, d) {
		...
		function G(e, n) {
			return e.nodeType != n.nodeType || e.nodeName != n.nodeName || A(e) != A(n);
		}
		function H(e, n) {
			if (g(S, e)) return;
			let u = n.cloneNode(!0);
		...
		function W(e, n) {
			if ((e._x_isShown && !n._x_isShown) || (!e._x_isShown && n._x_isShown)) return;
		...
		function V(e, n, u) {
			...
			for (; r; ) {
				...
				let m = (o) => o.nodeType === 8 && o.textContent === ' __BLOCK__ ',
					E = (o) => o.nodeType === 8 && o.textContent === ' __ENDBLOCK__ ';
				if (m(r) && m(i)) {
					let o = [],
						k,
						w = 0;
				...
				if (i.nodeType === 1 && D) {
					let o = a.next(n, r),
						k = !1;
					for (; !k && o; )
						i.isEqualNode(o) && ((k = !0), ([e, i] = K(e, r, i)), (y = A(i))), (o = a.next(n, o));
				}
				if (x !== y) {
					if (!x && y) {
						(f[y] = i),
					...
					if ((x && !y && p[x] && ((e = a.replace(e, i, p[x])), (i = p[x])), x && y)) {
						let o = p[x];
